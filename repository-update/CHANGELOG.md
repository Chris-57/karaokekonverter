...
- Add an explicit restore action, offline delivery regressions and setup/recovery/acceptance guides. The owner confirmed bootstrap and OIDC authentication; the first fully verified automated deployment and restore remain owner-run acceptance.
